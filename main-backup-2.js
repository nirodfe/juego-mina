...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        for (let x = 0; x < gridSize; x++) {
            for (let y = 0; y < gridSize; y++) {
                this.add.rectangle(x * tileSize, y * tileSize, tileSize, tileSize, 0x444444)
                    .setOrigin(0)
                    .setStrokeStyle(1, 0xffffff); // Añade bordes blancos para distinguir las cuadrículas
            }
        }
        ...
        // Añadir el personaje
        this.player = this.physics.add.sprite(5 * tileSize, 5 * tileSize, null).setOrigin(0);
